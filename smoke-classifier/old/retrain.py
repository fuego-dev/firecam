...
def add_final_retrain_ops(class_count, final_tensor_name, bottleneck_tensor,
  ...
  with tf.name_scope('train'):
    optimizer = tf.train.GradientDescentOptimizer(FLAGS.learning_rate)#tf.train.AdadeltaOptimizer(FLAGS.learning_rate)#tf.train.GradientDescentOptimizer(FLAGS.learning_rate)
